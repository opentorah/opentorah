...
The papers in `docs/paper` are processed by
https://github.com/dubinsky/site-publisher[Podval Site Publisher], not by a Gradle Asciidoctor task.
This file is the history of that switch (Gradle plugin, then calling Asciidoctor from the build).
