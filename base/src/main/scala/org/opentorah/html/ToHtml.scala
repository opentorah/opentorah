...
trait ToHtml[R <: Has[?]]:
  ...
  private def processFootnotes(element: ScalaXml.Element): URIO[Has[Footnotes] & R, ScalaXml.Element] = for
  ...
  private def processFootnote(element: ScalaXml.Element): URIO[Has[Footnotes] & R, ScalaXml.Element] =  for
  ...
  ): URIO[Has[Footnotes] & R, ScalaXml.Element] = for
