...
class JerusalemTanachImporter(inputDirectory: String, metadataDirectory: String, outputDirectory: String) extends TanachImporter(inputDirectory, metadataDirectory, outputDirectory)  {
