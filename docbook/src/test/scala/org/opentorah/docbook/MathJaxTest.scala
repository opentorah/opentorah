...
///    test(useJ2V8 = true)
  ...
  it should "typeset E = mc^2" in test("emc2", "E = mc^2",
     s"""|<svg xmlns:xlink="${Namespace.XLink.uri}" width="9.155ex" height="3.009ex" style="vertical-align: -0.505ex;" viewBox="0 -1078.4 3941.5 1295.7" role="img" focusable="false" ${Namespace.Svg}>
         |<defs>
  ...
  it should "typeset quadratic" in test("quadratic", "x = {-b \\pm \\sqrt{b^2-4ac} \\over 2a}.",
     s"""|<svg xmlns:xlink="${Namespace.XLink.uri}" width="18.429ex" height="7.009ex" style="vertical-align: -1.755ex;" viewBox="0 -2262.4 7934.7 3017.9" role="img" focusable="false" ${Namespace.Svg}>
         |<defs>
