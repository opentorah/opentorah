...
trait DocBook2 extends Section {
  ...
  protected def mainStylesheetBody(values: NonOverridableParameters): Seq[Node]

  def paramsStylesheet(parameters: Seq[(String, Parameters)]): Elem = {
    <xsl:stylesheet xmlns:xsl={Namespace.Xsl.uri} version={Namespace.Xsl.version(usesDocBookXslt2)}>
      <!-- DO NOT EDIT! Generated by the DocBook plugin. -->
...
object DocBook2 {
  ...
  private def parametersBySection(parameters: Seq[(String, Parameters)]): Seq[Node] = {
    val result = for {
  ...
  private def toXml(parameters: Parameters): Seq[Elem] =
