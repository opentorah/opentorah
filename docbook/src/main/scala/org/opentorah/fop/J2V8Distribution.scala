...
final class J2V8Distribution:
  ...
  val version: Option[String] = os match
    case Platform.Os.Windows | Platform.Os.Mac => Some("4.6.0")
    ...
    case Platform.Os.Linux => Some("4.8.0")
    case _ => None

  val osName: String = os match
    case Platform.Os.Windows => "win32"
    case Platform.Os.Mac     => "macosx"
    case Platform.Os.Linux   => "linux"
    case _          => throw IllegalArgumentException()

  val archName: String = architecture match
    case Platform.Architecture.i686   => "x86"
    case Platform.Architecture.x86_64 => "x86_64"
    case Platform.Architecture.amd64  => "x86_64"
    case _                            => throw IllegalArgumentException()
