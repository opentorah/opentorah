...
public final class BirkatHahama {
    ...
    public void print() {
        ...
        for (int cycle = 0; cycle <= 214; cycle++) {
            final JewishDate jDate = Tkufos.birkasHachama(cycle);
            final GregorianDate gDate = GregorianCalendar.getInstance().dateFromDays(jDate.getDays());
    ...
    public void tabulate() {
        ...
        for (int cycle = 0; cycle <= 214; cycle++) {
            final JewishDate date = Tkufos.birkasHachama(cycle);
