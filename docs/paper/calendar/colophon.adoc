...
link:/paper/calendar/calendar/calendar.html[chunked HTML],
link:/paper/calendar/calendar.html[one HTML file],
link:/paper/calendar/calendar.pdf[PDF].
...
Copyright 1991-2026 by Leonid Dubinsky.
