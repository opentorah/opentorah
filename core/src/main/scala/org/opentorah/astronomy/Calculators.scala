...
object Calculators:
  class TextLike extends Calculators:
    ...
    override def sunLongitudeCorrection: Rotation => Rotation = SunLongitudeCorrection.calculate
    ...
    override def moonAnomalyVisible: Position => Rotation = MoonAnomalyVisible.corrected.calculate
    override def moonHeadMean: Int => Rotation = MoonHeadMean.calculate
    override def moonLatitude: Rotation => Rotation = MoonLatitude.calculate
